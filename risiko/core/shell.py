...
from ..exceptions.shotugn_exception import ShellException
...
class Shell(BaseModel):
    ...
    def load(self, bullet_type:Bullet) -> Bullet:
        ...
        """Loads a shell into the shotgun. Raises a ShellException if the shell is already loaded."""
    ...
    def unload(self) -> Bullet:
        ...
        """ Unloads the shell from the shotgun. Returns the unloaded shell. """
